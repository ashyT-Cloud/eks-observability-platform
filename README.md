...
Prometheus successfully exposed Kubernetes and node metrics through multiple active targets.
...
AWS EBS
      │
      ▼
LokiThe AWS EBS CSI Driver provides Kubernetes integration with EBS volumes.
